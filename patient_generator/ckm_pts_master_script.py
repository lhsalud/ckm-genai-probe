...
Original file is located at
    https://colab.research.google.com/drive/1oRHTc8YEBLEzHloJ1UnpIQqWVSBiy1vw
"""
...
def approx_ckm_stage(entries, ontology):
    ...
    rf = [n for n in ("STAGE_1_ADIPOSITY", "STAGE_2_METABOLIC_CKD", "VERY_HIGH_CKD") if hits[n]]

    if has_cvd:
        if rf:
            stage, used = 4, ["CLINICAL_CVD"] + rf     # 4b if kidney failure else 4a
        else:
